 ...
 * Reads configuration from CommonVariables.
 *
 * @returns {Promise<boolean | undefined>} True if connected successfully, undefined otherwise.
 * @throws Throws if MONGO_URI is not provided.
 */
export async function connectToDb(): Promise<boolean | undefined> {
	...
	console.log(`🔌 Connecting to MongoDB at URI: ${MONGO_URI}, Database: ${MONGO_DB_NAME || 'default'}`);
